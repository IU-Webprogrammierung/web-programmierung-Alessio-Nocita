...
const PostListSidebar = () => {
    return(
        <aside className="hidden text-[#333] bg-[#f0f0f0] max-w-[20vw] justify-self-end p-5 mr-10 mb-20 row-start-2 row-end-3 col-start-2 col-end-3
                            desktop:block" 
            ...
            <ul className="list-none">
                <li className="mb-5 text-[#333] font-bold text-lg no-underline hover:underline">
