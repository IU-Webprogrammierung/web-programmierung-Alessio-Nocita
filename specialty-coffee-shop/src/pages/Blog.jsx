...
const Blog = ({ viewport }) => {
  return (
    <main
      className="flex flex-col h-auto w-screen max-h-none
                        desktop:grid desktop:grid-cols-[70%_30%] desktop:grid-rows[auto_1fr]"
    >
      <h1
        className="row-start-1 row-end-2 col-start-1 col-end-3 mb-5 text-center 
            desktop:mb-10 desktop:text-5xl"
      >
        Blog
      </h1>
      <section
        className="flex flex-col items-center row-start-2 row-end-3 col-start-1 col-end-2 bg-transparent h-auto min-h-none m-0
      ...
      >
        ...
        >
          ...
          >
            <img
              className="w-screen h-[240px] object-cover object-center
                                        tablet:h-[400px]
                                        desktop:w-[35vw] desktop:h-full"
              src={blogPost1}
              alt="Kaffee-Plantage in Äthiopien"
            />
            <figcaption>Kaffee-Plantage in Äthiopien</figcaption>
          </figure>
          <div
            className="flex flex-col align-start justify-center py-10 text-left w-[80vw] max-w-[90vw] mx-auto 
                                        desktop:w-[400px] desktop:max-w-[30vw] desktop:odd:order-2 desktop:even:order-1"
          >
            <h3
              className="text-2xl mb-5 text-center font-bold max-w-[80vw]
                                        laptop:font-size-md laptop:max-w-[680px]
                                        desktop:text-left desktop:pl-5"
            >
              Äthiopien: Wiege des Kaffees
            </h3>
            <p
              className="text-md mb-3 max-w-[80vw]
                                        tablet:text-lg
                                        laptop:max-w-[680px]
                                        desktop:text-lg desktop:p-5"
            >
          ...
          >
            <img
              className="w-screen h-[240px] object-cover object-center
                                        ...
                                        desktop:w-[35vw] desktop:h-full"
              src={blogPost2}
              alt="ein Café und eine Espresso-Maschine"
            />
            <figcaption>Den perfekte Espresso zubereiten</figcaption>
          </figure>
          <div
            className="flex flex-col align-start justify-center py-10 text-left w-[80vw] max-w-[80vw] mx-auto
                                desktop:w-[400px] desktop:max-w-[30vw] desktop:odd:order-2 desktop:even:order-1"
          >
            <h3
              className="text-2xl mb-5 text-center font-bold max-w-[80vw]
            ...
            <p
              className="text-md mb-3 max-w-[80vw] 
                                        desktop:text-lg"
            >
              Espresso ist die Königsdisziplin der Kaffeezubereitung – und mit
              ein paar einfachen Tricks kannst du auch zu Hause ein perfektes
              Ergebnis erzielen. Wir zeigen dir, wie du deinen Espresso optimal
              extrahierst, welcher Mahlgrad der richtige ist und worauf du bei
              der Wahl der Bohnen achten solltest. Mit unseren Tipps und etwas
              Übung gelingt dir bald ein Espresso wie vom Profi...
            </p>
            <Button
              text="Mehr lesen"
              link="/post/espresso"
          ...
          >
            <img
              className="w-screen h-[240px] object-cover object-center
                                        ...
                                        desktop:w-[35vw] desktop:h-full"
              src={blogPost3}
              alt="Kaffee wird in einer Espresso Tasse gegossen"
            />
            <figcaption>Single Origin vs Blend</figcaption>
          </figure>

          <div
            className="flex flex-col align-start justify-center text-left py-10 w-[80vw] max-w-[80vw] mx-auto
                                desktop:w-[400px] desktop:max-w-[30vw] desktop:odd:order-2 desktop:even:order-1"
          >
            <h3
              className="text-2xl mb-5 text-center font-bold max-w-80vw]
                                        ...
                                        desktop:text-left"
            >
              Single Origin vs. Blend: Die Unterschiede erklärt
            </h3>
            <p
              className="text-md mb-3 max-w-[80vw]
                                        desktop:text-lg"
            >
              Single Origin oder Blend – was ist der Unterschied und welcher
              Kaffee passt am besten zu deinem Geschmack? Wir erklären dir die
              Vor- und Nachteile beider Varianten und zeigen dir, wie du die
              richtige Wahl für deinen perfekten Kaffeegenuss triffst...
            </p>
            <Button
              text="Mehr lesen"
              link="/post/origin"
          ...
          >
            ...
            <p
              className="text-md mb-3 max-w-[80vw]
                                        desktop:text-lg"
            >
              Ein guter Kaffee ist ein Genuss – aber ein Kaffee mit kunstvoller
              Latte Art ist ein echtes Erlebnis. Die filigranen Muster, die
              Baristas auf den samtigen Milchschaum zaubern, sind nicht nur ein
              optischer Hingucker, sondern auch ein Zeichen für höchste
              Kaffeequalität und Handwerkskunst. Latte Art entsteht durch das
              perfekte Zusammenspiel von Espresso und geschäumter Milch.
              Entscheidend ist die richtige Textur...
            </p>
            <Button
              text="Mehr lesen"
              link="/post/latte"
