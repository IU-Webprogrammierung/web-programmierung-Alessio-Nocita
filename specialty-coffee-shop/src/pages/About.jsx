...
const About = () => {
    return (
        <main>
            <section className="flex flex-col items-center my-0 mx-auto max-w-[1440px] bg-[#f0f0f0] pt-10 pb-5 mb-20" aria-labelledby="title">
            <h1 class="text-5xl mb-10" id="title">Über uns</h1>
                <article className="flex flex-col items-center gap-0 m-0 w-full text-[#333]
                                    laptop:flex-row laptop:items-start laptop:gap-5">
                    <figure>
                        <img className="w-screen object-cover object-[50%_30%] max-h-[30vh] mb-5 p-0
                                        laptop:max-w-[40vw] laptop:max-h-none laptop:flex-shrink-0 laptop:mr-5 laptop:mb-3" src={aboutUs} alt="Die Inhaber in der Rösterei" />
                    ...
                    <h2 className="text-2xl mb-5 text-center">Specialty Coffee: Guter Geschmack als Leidenschaft</h2>
