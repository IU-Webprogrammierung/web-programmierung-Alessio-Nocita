...
const Post = () => {
    ...
    <main className="pb-10">
        <section>
            <article className="grid grid-cols-1 grid-rows-[auto_auto_auto_240px_1fr_auto] w-screen text-[#333] bg-[#f0f0f0] justify-center mx-auto pb-10 mb-20 
                                laptop:w-4/5
                                desktop:grid-rows-[auto_auto_auto_400px_1fr_auto]">
                <h1 className="text-xl text-center mt-5 w-full mx-auto mb-2 laptop:text-3xl desktop:mt-10 desktop:w-4/5">Äthiopien: Wiege des Kaffees</h1>
                <time className="text-md text-center mt-1 laptop:text-lg" datetime="2021-09-15">15. September 2021</time>
                <h2 className="text-md text-center mb-5 laptop:text-lg">Ein Artikel von <address className="inline">Max Mustermann</address></h2>

                <figure className="h-[240px] w-full mx-auto desktop:h-[400px]">
                    <img className="w-full h-[240px] object-cover object-center 
                                    desktop:h-[400px]" src={blogPost} alt="Eine Kaffee-Plantage in Äthiopien" />
                    <figcaption>Eine Kaffee-Plantage in Äthiopien</figcaption>
                </figure>
<div className="w-4/5 text-left mx-auto py-5 px-5 
                tablet:w-3/4
...
<h4 className="font-bold mt-5 mb-1 text-xl">Die Vielfalt äthiopischer Kaffeesorten</h4>
...
<p>Für Kaffeeliebhaber ist äthiopischer Kaffee eine Reise durch die Geschichte und die Aromen des Ursprungslandes des Kaffees. Egal, ob als Filterkaffee, in der French Press oder als milder Espresso – äthiopischer Kaffee bietet eine faszinierende Geschmackstiefe, die man probiert haben muss.</p>
             ...
             <div className="text-right w-3/4 justify-self-center
                             desktop:w-2/3">
