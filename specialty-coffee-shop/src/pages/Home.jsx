...
const Home = ({viewport}) => {
    ...
    <main>
        ...
        <section className="hero-section" aria-labelledby="coffee-title">
        <figure className="w-[50vw] h-full flex">
