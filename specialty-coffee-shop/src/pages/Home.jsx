    ...
    <main>
      ...
      >
        ...
        >
          <img
            className="h-[240px] w-screen max-h-[240px] object-cover object-[50%_30%]
                                ...
                                "
            src={heroImage}
            alt="Die Gründer von Specialty Coffee Duisburg in der Rösterei"
          />
          <figcaption>
            Die Gründer von Specialty Coffee Duisburg in der Rösterei
          </figcaption>
        </figure>
        <article
        ...
        >
          ...
          <p className="w-4/5 font-normal p-2">
            Bei Specialty Coffee Duisburg verbinden wir handverlesene
            Kaffeebohnen aus nachhaltigem Anbau mit unserer Leidenschaft für
            außergewöhnliche Aromen. Wir setzen auf direkte Partnerschaften mit
            Farmern, um Qualität, Transparenz und faire Bedingungen zu
            garantieren. Unsere sorgfältige Röstung bringt die individuellen
            Geschmacksprofile jeder Herkunft zur Geltung – von fruchtig-leicht
            bis schokoladig-intensiv. Genieße Kaffee, der nicht nur gut
            schmeckt, sondern auch Gutes bewirkt.
          </p>
        </article>
      </section>
      ...
      <section
        className="flex flex-col justify-center items-center mx-auto my-8 w-[90vw]"
        aria-label="Übersicht unseres Service"
      >
        <h1>Unser Service</h1>
        <article
        ...
        >
          ...
          >
            <p>
              Wir wählen nur die besten Bohnen aus nachhaltigem Anbau, um dir
              ein unvergleichliches Geschmackserlebnis zu bieten – von
              exotischen Fruchtnoten bis zu nussigen Nuancen.
            </p>
          </Card>
          <Card src={cardIcon2} alt="Icon eines Handschlags" title="Fair Trade">
            <p>
              Wir setzen auf direkte Partnerschaften mit Kaffeebauern weltweit,
              um faire Preise und Bedingungen zu garantieren. Gemeinsam für eine
              nachhaltige Zukunft
            </p>
          </Card>
          <Card
          ...
          >
            <p>
              Erlebe unsere Kaffeespezialitäten direkt in unserer gemütlichen
              Bar in Duisburg. Frisch aufgebrüht, mit Liebe zubereitet – der
              perfekte Ort für echte Kaffeegenießer.
            </p>
          </Card>
          <Card
            src={cardIcon4}
          ...
          >
            <p>
              Lerne die Kunst des perfekten Kaffees in unseren Barista-Kursen
              oder entdecke exklusive Coffee-Tastings. Werde selbst zum
              Experten!
            </p>
          </Card>
        </article>
      ...
      >
        ...
        >
          ...
          />
          <figcaption>
            Kaffeebohnen auf einem rustikalen Tisch vor Bokeh-Lichtern
          </figcaption>
        </figure>
        <article
          className="flex flex-col h-auto items-center w-screen mb-5
        ...
        >
          <h1
            className="mt-6 text-center
                            laptop:mb-6
                            desktop:m-0 desktop:mt-0 desktop:text-right"
            id="coffee-title"
          >
            Unser Kaffee
          </h1>
          <p className="w-4/5 font-normal p-2">
            Unser Kaffee ist so vielfältig wie die Regionen, aus denen er
            stammt. Von den fruchtig-floralen Noten äthiopischer Bohnen über die
            schokoladige Tiefe brasilianischer Ernten bis hin zu den würzigen
            Akzenten indischer Spezialitäten und der lebendigen Süße aus
            Guatemala – wir kennen und lieben den Charakter jeder Herkunft.
            Durch unsere schonende Röstung und die Kunst, außergewöhnliche
            Blends zu kreieren, bringen wir das Beste aus jeder Bohne in deine
            Tasse. Das Ergebnis: Kaffee, der nicht nur schmeckt, sondern
            Geschichten erzählt – von den Feldern bis in deine Tasse.
          </p>
        </article>
      </section>
      ...
      >
        <h1 className="mt-8 mb-4 text-2xl laptop:text-4xl">
          Letzter Blog-Post
        </h1>
        <article
        ...
        >
          ...
          >
            <img
              className="w-full object-cover laptop:w-screen laptop:max-h-[400px]
                                    desktop:h-[600px] desktop:max-h-[600px]"
              src={featuredBlogPostImage}
              alt="Eine Landschaft einer Kaffee-Plantage in Äthiopien"
            />
            <figcaption>
              Eine Landschaft einer Kaffee-Plantage in Äthiopien
            </figcaption>
          </figure>
        </article>
      </section>
